...
impl TextCat {
    ...
    fn supported_languages() -> Vec<&'static str> {
        vec![
            ...
            "dutch", "russian", "japanese", "arabic", "hindi",
            "korean", "turkish", "polish", "swedish", "danish",
            "finnish", "thai", "vietnamese", "indonesian", "czech", "hungarian",
            "romanian", "ukrainian", "greek", "hebrew", "bengali", "tamil",
            "urdu", "catalan", "slovenian", "lithuanian", "latvian",
            "macedonian",
        ]
    }
}
